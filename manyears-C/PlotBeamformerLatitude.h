#ifndef PLOTBEAMFORMERLATITUDE_H
#define PLOTBEAMFORMERLATITUDE_H
...
//class PlotBeamformerLatitude : public QWidget
//{
//
//    Q_OBJECT
//
...
//    ***********************************************************/
//
//    PlotBeamformerLatitude(int _width, int _height, int _samplingRate, int _hopSize, PotentialSourceManager *_sourceManager);
//
//    /***********************************************************
//    * Update graph                                             *
//    ***********************************************************/
