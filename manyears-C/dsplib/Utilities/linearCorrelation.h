/*******************************************************************************
 * ManyEars: linearCorrelation - Header                                        *
 * --------------------------------------------------------------------------- *
 *                                                                             *
...
struct objLinearCorrelation
{

    unsigned int vectorASize;
    unsigned int vectorASizeExt;
    unsigned int vectorAnBlocks;
    unsigned int vectorAZeroPadding;
    unsigned int vectorABlockPadding;

    unsigned int vectorBSize;
    unsigned int vectorBSizeExt;
    unsigned int vectorBnBlocks;
    unsigned int vectorBZeroPadding;
    unsigned int vectorBBlockPaddingBefore;
    unsigned int vectorBBlockPaddingAfter;

    unsigned int vectorResultSize;
    unsigned int vectorResultSizeExt;
    unsigned int vectorResultnBlocks;
    unsigned int vectorResultZerosBefore;
    unsigned int vectorResultZerosAfter;
