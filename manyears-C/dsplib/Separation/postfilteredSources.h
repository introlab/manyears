/*******************************************************************************
 * ManyEars: Postfiltered Sources - Header                                     *
 * --------------------------------------------------------------------------- *
 *                                                                             *
...
#define      POSTFILTERED_NOSOURCE              ID_NOSOURCE

struct objPostfilteredSources
{
    ...
    // +-------------------------------------------------------------------+
        ...
        // Sources ID
        struct objIdList sourcesID;

        // Sources frames
        float** sourcesFramesReal;
        float** sourcesFramesImag;
